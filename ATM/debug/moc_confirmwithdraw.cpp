...
void ConfirmWithdraw::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ConfirmWithdraw *_t = static_cast<ConfirmWithdraw *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ConfirmWithdraw::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ConfirmWithdraw.data,
      qt_meta_data_ConfirmWithdraw,  qt_static_metacall, nullptr, nullptr}
};
...
void *ConfirmWithdraw::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConfirmWithdraw.stringdata0))
        return static_cast<void*>(const_cast< ConfirmWithdraw*>(this));
